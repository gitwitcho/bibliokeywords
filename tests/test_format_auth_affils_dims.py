...
def test_format_auth_affils_dims():
    ...
    # Test case with multiple affiliations
    input_str = 'Miño de Kaspar, Herminia (Department of Ophthalmology, Stanford University School of Medicine, 300 Pasteur Dr. , Room A-157, 94305, Stanford, California, USA; Department of Ophthalmology, Ludwig-Maximilians-Universität, Mathildenstrasse 8, 80336, Munich, Germany)'
    expected_output_str = 'Miño de Kaspar, H. (Department of Ophthalmology, Stanford University School of Medicine, 300 Pasteur Dr. , Room A-157, 94305, Stanford, California, USA; Department of Ophthalmology, Ludwig-Maximilians-Universität, Mathildenstrasse 8, 80336, Munich, Germany)'
    output_str = format_auth_affils_dims(input_str)
    assert output_str == expected_output_str
